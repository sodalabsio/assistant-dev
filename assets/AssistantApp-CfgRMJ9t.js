const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/reduxStore-Z738gSe_.js","assets/index-2ggoq_kh.js","assets/index-lhbRWN1Q.css","assets/llm-DlK4rvk8.js","assets/boot-C4yj9leu.js","assets/collectionsThunks-DHD6ob0u.js","assets/slackSocketMode-BZYmUazp.js","assets/durability-DxT4gB9w.js","assets/publicImagesSlice-B3dB8NpD.js","assets/api-D0E4HlYa.js","assets/userImagesSlice-B9-AopyF.js","assets/ingestDocument-0Ku2PFM4.js","assets/reduxStore-rduMDMl3.css","assets/faultExport-B2sNvp_g.js","assets/Assistant-MfKTm1Aj.js","assets/ReduxAppDataRoot-u-hr3B4H.js","assets/cronStream-BixcihLY.js","assets/canonicalProjectPatchSet-BBYhAC8N.js","assets/openrouter-BgQZ_DHI.js","assets/pkce-CpKKDV7R.js","assets/oauth-CKngOZSX.js","assets/App-Dr_AroCD.js","assets/oauthCallbackContract-B3NnAqVX.js","assets/isObject-CGZ9pm3u.js","assets/toNumber-DbsqjrQD.js","assets/Assistant-Ph_f2CJ_.css"])))=>i.map(i=>d[i]);
import{r as ee,j as G,c as Nt,w as at,R as Ml,s as Xu,_ as sa,d as er,g as ju,e as $u,f as qu}from"./index-2ggoq_kh.js";import{ck as bl,cl as Yu,cm as El,cn as Ku,co as Zu,cp as Ju,cq as Qu,cr as ed,cs as Ei,ct as td,cu as nd,cv as Tl,cw as id,cx as za,cy as rd,cz as Nn,cA as ar,cB as cr,u as lr,cC as oa,cD as sd,cE as od,cF as ad,k as cd,cG as ld,cH as ud,cI as Ha,cJ as dd,cK as hd,cL as fd,cM as pd,cN as wl,cO as md,cP as gd,cQ as vd,cR as _d,cS as Al,cT as Rl,cU as Cl,cV as Pl,cW as xd,cX as Il,cY as Sd,cZ as yd,c_ as Md,c$ as aa,d0 as Ki,d1 as mn,d2 as bd,d3 as Va,d4 as Ll,d5 as Ed,d6 as Ga,d7 as Td,d8 as wd,d9 as Ad,da as Dl,db as ca,dc as Rd,c5 as Cd,dd as Pd,de as Id,df as Ld,dg as Dd,dh as Ye,di as Ud,bn as Nd,aC as Od,aE as Ul,aF as Fd,dj as kd,dk as la,dl as Nl,dm as Ol,dn as Bd,dp as ua,dq as zd,dr as Hd,ds as Vd,dt as Gd,du as Wd,dv as Xd,dw as jd,dx as hs,dy as $d,dz as qd,dA as Yd,dB as Kd,dC as Zd,dD as Jd,dE as Qd,dF as eh,dG as th,dH as nh,dI as ih,dJ as rh,dK as sh,dL as oh,dM as ah,dN as ch,dO as lh,dP as Wa,dQ as uh,dR as ts,dS as dh,dT as hh,aJ as fh,dU as ph,dV as mh,dW as gh,dX as vh,dY as Fl,dZ as _h,d_ as xh,d$ as Sh,e0 as yh,e1 as Xa,e2 as Mh,e3 as ja,e4 as bh,e5 as Eh,e6 as Th,T as Sr,e7 as $a,e8 as wh,B as qa}from"./reduxStore-Z738gSe_.js";import{d as jt,a as kl,b as da,r as Ah,c as Rh,R as Ch}from"./ReduxAppDataRoot-u-hr3B4H.js";import{e as Ph,f as Ya,g as Ih,i as Lh,u as Dh}from"./durability-DxT4gB9w.js";import{l as Uh,d as Nh,S as Bl}from"./boot-C4yj9leu.js";import{h as Oh,l as Fh,s as ti}from"./collectionsThunks-DHD6ob0u.js";import{g as zl,f as kh,i as Bh,o as oo,p as zh}from"./llm-DlK4rvk8.js";import{t as Hl}from"./App-Dr_AroCD.js";const Vl=ee.createContext(null);function ha(){return ee.useContext(Vl)}const Hh=typeof Symbol=="function"&&Symbol.for,Vh=Hh?Symbol.for("mui.nested"):"__THEME_NESTED__";function Gh(n,e){return typeof e=="function"?e(n):{...n,...e}}function Wh(n){const{children:e,theme:t}=n,i=ha(),r=ee.useMemo(()=>{const s=i===null?{...t}:Gh(i,t);return s!=null&&(s[Vh]=i!==null),s},[t,i]);return G.jsx(Vl.Provider,{value:r,children:e})}function Xh(n){const e=bl(),t=Yu()||"",{modularCssLayers:i}=n;let r="mui.global, mui.components, mui.theme, mui.custom, mui.sx";return!i||e!==null?r="":typeof i=="string"?r=i.replace(/mui(?!\.)/g,r):r=`@layer ${r};`,El(()=>{const s=document.querySelector("head");if(!s)return;const o=s.firstChild;if(r){if(o&&o.hasAttribute?.("data-mui-layer-order")&&o.getAttribute("data-mui-layer-order")===t)return;const a=document.createElement("style");a.setAttribute("data-mui-layer-order",t),a.textContent=r,s.prepend(a)}else s.querySelector(`style[data-mui-layer-order="${t}"]`)?.remove()},[r,t]),r?G.jsx(Ku,{styles:r}):null}const Ka={};function Za(n,e,t,i=!1){return ee.useMemo(()=>{const r=n&&e[n]||e;if(typeof t=="function"){const s=t(r),o=n?{...e,[n]:s}:s;return i?()=>o:o}return n?{...e,[n]:t}:{...e,...t}},[n,e,t,i])}function Gl(n){const{children:e,theme:t,themeId:i}=n,r=bl(Ka),s=ha()||Ka,o=Za(i,r,t),a=Za(i,s,t,!0),c=(i?o[i]:o).direction==="rtl",l=Xh(o);return G.jsx(Wh,{theme:a,children:G.jsx(Zu.Provider,{value:o,children:G.jsx(Ju,{value:c,children:G.jsxs(Qu,{value:i?o[i].components:o.components,children:[l,e]})})})})}const fa="mode",pa="color-scheme",jh="data-color-scheme";function $h(n){const{defaultMode:e="system",defaultLightColorScheme:t="light",defaultDarkColorScheme:i="dark",modeStorageKey:r=fa,colorSchemeStorageKey:s=pa,attribute:o=jh,colorSchemeNode:a="document.documentElement",nonce:c}=n||{};let l="",u=o;if(o==="class"&&(u=".%s"),o==="data"&&(u="[data-%s]"),u.startsWith(".")){const p=u.substring(1);l+=`${a}.classList.remove('${p}'.replace('%s', light), '${p}'.replace('%s', dark));
...
#define LOW_PRECISION`),e}function BS(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===lu?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===pg?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===fn&&(e="SHADOWMAP_TYPE_VSM"),e}function zS(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ii:case Li:e="ENVMAP_TYPE_CUBE";break;case cs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function HS(n){let e="ENVMAP_MODE_REFLECTION";return n.envMap&&n.envMapMode===Li&&(e="ENVMAP_MODE_REFRACTION"),e}function VS(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case uu:e="ENVMAP_BLENDING_MULTIPLY";break;case Dg:e="ENVMAP_BLENDING_MIX";break;case Ug:e="ENVMAP_BLENDING_ADD";break}return e}function GS(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function WS(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=BS(t),l=zS(t),u=HS(t),d=VS(t),p=GS(t),f=IS(t),g=LS(s),_=r.createProgram();let m,h,E=t.glslVersion?"#version "+t.glslVersion+`

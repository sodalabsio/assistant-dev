const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/reduxStore-C5O8VCOZ.js","assets/index-DLJ81u8y.js","assets/index--c1wzNd1.css","assets/llm-Bc09GD5V.js","assets/oauth-yImE6aai.js","assets/durability-C-KkhqHF.js","assets/slackSocketMode-DWjy5Z1m.js","assets/api-CqL7sijx.js","assets/reduxStore-B9xD6_Om.css","assets/faultExport-izMK9EU9.js","assets/Assistant-BRF59lat.js","assets/ReduxAppDataRoot-DA1xY6dr.js","assets/cronStream-BeFRLi6y.js","assets/canonicalProjectPatchSet-Dmt_Pdvv.js","assets/openrouter-Dv-5PqvB.js","assets/pkce-CpKKDV7R.js","assets/oauth-DfakV9nM.js","assets/App-DJefbZ3J.js","assets/isObject-CGZ9pm3u.js","assets/toNumber-DbsqjrQD.js","assets/Assistant-Dae88zj3.css"])))=>i.map(i=>d[i]);
import{r as K,j as B,c as tn,w as ut,s as Oc,_ as Io,d as Xi,g as Fc,R as Bc,e as zc,f as kc}from"./index-DLJ81u8y.js";import{cb as Dl,cc as Vc,cd as Il,ce as Hc,cf as Gc,cg as Wc,ch as Xc,ci as qc,cj as vi,ck as jc,cl as $c,cm as Ul,cn as Yc,co as da,cp as Kc,cq as Ln,cr as Ki,cs as Zi,ct as Zc,aB as Jc,x as Ns,cu as Qc,j as eu,cv as tu,cw as Nl,cx as nu,bW as ha,cy as iu,cz as ru,cA as su,cB as ou,cC as au,cD as lu,cE as cu,cF as fa,cG as uu,cH as du,T as cr,cI as pa,cJ as hu,E as ma}from"./reduxStore-C5O8VCOZ.js";import{d as qn,R as fu,a as pu}from"./ReduxAppDataRoot-DA1xY6dr.js";import{i as Ji,m as Uo,o as mu,p as Ol}from"./llm-Bc09GD5V.js";import{m as gu,n as vu,o as _u,c as xu,q as Su,t as Mu,S as Fl}from"./durability-C-KkhqHF.js";const Bl=K.createContext(null);function No(){return K.useContext(Bl)}const yu=typeof Symbol=="function"&&Symbol.for,Eu=yu?Symbol.for("mui.nested"):"__THEME_NESTED__";function Tu(n,e){return typeof e=="function"?e(n):{...n,...e}}function bu(n){const{children:e,theme:t}=n,i=No(),r=K.useMemo(()=>{const s=i===null?{...t}:Tu(i,t);return s!=null&&(s[Eu]=i!==null),s},[t,i]);return B.jsx(Bl.Provider,{value:r,children:e})}function wu(n){const e=Dl(),t=Vc()||"",{modularCssLayers:i}=n;let r="mui.global, mui.components, mui.theme, mui.custom, mui.sx";return!i||e!==null?r="":typeof i=="string"?r=i.replace(/mui(?!\.)/g,r):r=`@layer ${r};`,Il(()=>{const s=document.querySelector("head");if(!s)return;const o=s.firstChild;if(r){if(o&&o.hasAttribute?.("data-mui-layer-order")&&o.getAttribute("data-mui-layer-order")===t)return;const a=document.createElement("style");a.setAttribute("data-mui-layer-order",t),a.textContent=r,s.prepend(a)}else s.querySelector(`style[data-mui-layer-order="${t}"]`)?.remove()},[r,t]),r?B.jsx(Hc,{styles:r}):null}const ga={};function va(n,e,t,i=!1){return K.useMemo(()=>{const r=n&&e[n]||e;if(typeof t=="function"){const s=t(r),o=n?{...e,[n]:s}:s;return i?()=>o:o}return n?{...e,[n]:t}:{...e,...t}},[n,e,t,i])}function zl(n){const{children:e,theme:t,themeId:i}=n,r=Dl(ga),s=No()||ga,o=va(i,r,t),a=va(i,s,t,!0),c=(i?o[i]:o).direction==="rtl",l=wu(o);return B.jsx(bu,{theme:a,children:B.jsx(Gc.Provider,{value:o,children:B.jsx(Wc,{value:c,children:B.jsxs(Xc,{value:i?o[i].components:o.components,children:[l,e]})})})})}const Oo="mode",Fo="color-scheme",Au="data-color-scheme";function Ru(n){const{defaultMode:e="system",defaultLightColorScheme:t="light",defaultDarkColorScheme:i="dark",modeStorageKey:r=Oo,colorSchemeStorageKey:s=Fo,attribute:o=Au,colorSchemeNode:a="document.documentElement",nonce:c}=n||{};let l="",d=o;if(o==="class"&&(d=".%s"),o==="data"&&(d="[data-%s]"),d.startsWith(".")){const f=d.substring(1);l+=`${a}.classList.remove('${f}'.replace('%s', light), '${f}'.replace('%s', dark));
